        ...
        >
          ...
          >
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
              <defs>
                <marker id="move-arrowhead" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="3" markerHeight="3" orient="auto-start-reverse">
                  <polygon points="0 0, 10 5, 0 10" fill="#22c55e" />
                </marker>
                <marker id="support-arrowhead" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="3" markerHeight="3" orient="auto-start-reverse">
                  <polygon points="0 0, 10 5, 0 10" fill="#fbbf24" />
                </marker>
                <marker id="retreat-arrowhead" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="3" markerHeight="3" orient="auto-start-reverse">
                  <polygon points="0 0, 10 5, 0 10" fill="#22c55e" />
                </marker>
                <marker id="convoy-arrowhead" markerWidth="2" markerHeight="2.5" refX="3" refY="1.25" orient="auto">
