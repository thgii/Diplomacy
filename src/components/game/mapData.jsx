...
export const adjacencies = {
  ...
  'MAR': [{ to: 'BUR' }, { to: 'GAS' }, { to: 'GOL', naval: true }, { to: 'PIE' }, { to: 'PIE', naval: true }, { to: 'SPA/sc', naval: true }, { to: 'SPA' }],
  ...
  'SPA/sc': [{ to: 'GOL', naval: true }, { to: 'MAO', naval: true }, { to: 'POR', naval: true }, { to: 'MAR', naval: true }, { to: 'WES', naval: true }],
  ...
  'VEN': [{ to: 'ADR', naval: true }, { to: 'APU' }, { to: 'APU', naval: true }, { to: 'PIE' }, { to: 'ROM' }, { to: 'TRI' }, { to: 'TRI', naval: true }, { to: 'TYR' }, { to: 'TUS' }],
